...
| configs.styles | string | `""` (See [values.yaml]) | Define custom [CSS styles] for your argo instance. These settings will automatically mount the provided CSS and reference it in the argo configuration. |
